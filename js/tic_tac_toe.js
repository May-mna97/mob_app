...
// flagがpen-flagのときpenguinsのターンbear-flagのとbearのターン
let flag = "pen-flag";
...
// メッセージ
const msgtxt1 = '<p class="image"><img src ="img/penguins.jpg" width=61px height=61px></p><p class="text">Penguins Attak!</p>';
const msgtxt2 = '<p class="image"><img src ="img/whitebear.jpg" width=61px height=61px></p><p class="text">WhiteBear Attak!</p>';
...
// ***********************************************
// クリックしたsquareに, penguinsかbearを表示。画像を表示したsquareはクリックできないようにする, win or lose Judgement の呼び出し
...
function gameOver(status) {
    ...
    if(status==="penguins") {
        ...
        // winner-line whitebear high-light
        if (winningLine) {
            winningLine.forEach(function (square) {
...
// **************************************************
// clasListの使い方まとめ:https://qiita.com/tomokichi ruby/items/2460c5902d19b8cace5
